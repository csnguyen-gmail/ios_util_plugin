...
public class SwiftIosUtilPlugin: NSObject, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "ios_util_plugin", binaryMessenger: registrar.messenger())
    let instance = SwiftIosUtilPlugin()
